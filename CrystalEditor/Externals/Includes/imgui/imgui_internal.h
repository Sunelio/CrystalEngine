...
//#endif
    ...
    IMGUI_API void          RenderImage(ImDrawList* draw_list, ImTextureID user_texture_id, const ImVec2& p_min, const ImVec2& p_max, const ImVec2& uv_min, const ImVec2& uv_max, ImU32 col);
    IMGUI_API void          RenderArrow(ImDrawList* draw_list, ImVec2 pos, ImU32 col, ImGuiDir dir, float scale = 1.0f);
    IMGUI_API void          RenderSquare(ImDrawList* draw_list, ImVec2 pos, ImU32 col, float scale = 1.0f);
    IMGUI_API void          RenderStraightLines(ImDrawList* draw_list, ImVec2 pos, ImU32 col, float scale  = 1.0f);
    ...
    IMGUI_API void          ArrowEx(const char* str_id, ImGuiDir dir);
    IMGUI_API bool          ArrowButtonEx(const char* str_id, ImGuiDir dir, ImVec2 size_arg, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          SquareButtonEx(const char* str_id, ImVec2 size, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          StraightLinesButtonEx(const char* str_id, ImVec2 size, ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API bool          TreeNodeIconBehavior(ImGuiID id, const ImTextureID& textureId, const ImVec2& textureSize, ImGuiTreeNodeFlags flags, const char* label, const char* label_end = NULL);
