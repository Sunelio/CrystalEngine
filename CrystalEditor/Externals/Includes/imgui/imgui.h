...
namespace ImGui
{
    ...
    IMGUI_API bool          SquareButton(const char* str_id);
    IMGUI_API bool          StraightLinesButton(const char* str_id);
    ...
    IMGUI_API void          ImageWithID(const char* str_id, ImTextureID user_texture_id, const ImVec2& size, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), const ImVec4& tint_col = ImVec4(1, 1, 1, 1), const ImVec4& border_col = ImVec4(0, 0, 0, 0));
    ...
    IMGUI_API bool          TreeNodeIconEx(const char* label, const ImTextureID& textureId, const ImVec2& textureSize, ImGuiTreeNodeFlags flags = 0);
    ...
    IMGUI_API bool          CollapsingHeaderWithIcon(const char* label, const ImTextureID& textureId, const ImVec2& textureSize, ImGuiTreeNodeFlags flags);
    ...
    // Text Utilities
    IMGUI_API ImVec2        CalcCharSize(char c);
